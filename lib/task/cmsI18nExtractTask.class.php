 ...
 */
class cmsI18nExtractTask extends sfBaseTask
{
  /**
   * @see sfTask
   */
  protected function configure()
  {
    $this->addArguments(array(
      ...
      new sfCommandArgument('culture', sfCommandArgument::REQUIRED, 'The target language'),
    ));
    ...
    $this->briefDescription = 'Extracts i18n strings from php files for your sites (languages shared across sites)';

    $this->detailedDescription = <<<EOF
The [cms:i18n-extract|INFO] task extracts i18n strings from your project files
for the given application and target language (shared accross sites):

  [./symfony cms:i18n-extract frontend LANGUAGE|INFO]
...
If you want to display the new strings, use the [--display-new|COMMENT] option:
  ...
  [./symfony cms:i18n-extract --display-new frontend LANGUAGE|INFO]

To save them in the i18n message catalogue, use the [--auto-save|COMMENT] option:

  [./symfony cms:i18n-extract --auto-save frontend LANGUAGE|INFO]
...
[--display-old|COMMENT] option:
  ...
  [./symfony cms:i18n-extract --display-old frontend LANGUAGE|INFO]
...
appear as old strings but they are not:
  ...
  [./symfony cms:i18n-extract --auto-delete frontend LANGUAGE|INFO]
EOF;
  }
  ...
  public function execute($arguments = array(), $options = array())
  {
    ...
    $extract = new cmsI18nApplicationExtract(new $class($this->configuration, new sfNoCache(), $params), $arguments['culture']);
    $extract->extract();
