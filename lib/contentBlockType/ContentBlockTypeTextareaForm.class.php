<?php
class ContentBlockTypeTextareaForm extends ContentBlockTypeForm
{
  /**
   * Set up the field
   *
  ...
  public function configure()
  {
    ...
    $this->validatorSchema['value'] = new sfEnhancedValidatorString($this->getValidatorOptions(), array('max_length'=>'Character limit of %max_length% characters exceeded. Text was %current_length% characters long'));
  ...
  {
    return 'ContentBlockTypeTextarea';
  }
}