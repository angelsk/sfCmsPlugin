...
abstract class PluginListingItemForm extends BaseListingItemForm
{
	public function setup()
	{
		...
		$this->widgetSchema['item_date'] = new sfWidgetFormDateMooPicker();
		$this->validatorSchema['item_date'] = new sfValidatorDate(array('required'=>false));

		$defn = $manager->getTemplateDefinition($listing->template);
		...
		$choices = $manager->getItemStatusList($listing->template);
		...
		$this->widgetSchema->setLabel('item_date', 'Item date (optional)');
