<?php
sfContext::getInstance()->getResponse()->setTitle(htmlentities('Editing iframe' . ' - ' . $sitetree->title, null, 'utf-8', false), false);
...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <div class="sf_admin_form">
      <?php echo $form->renderFormTag(url_for(sprintf('iframeAdmin/edit?id=%s', $form->getObject()->id))); ?>
        ...
        <?php else : ?>
          <p>Sorry, you need publish permissions to be able to create/ edit an iFrame</p>
        <?php endif; ?>
      </form>
    </div>
  </div>
