...
// Or build this file again with packager using: packager build More/More More/Class.Refactor More/Date More/Date.Extras More/Fx.Reveal More/Drag More/Slider More/Color More/Locale More/Locale.en-GB.Date
/*
---
copyrights:
...
return(b)?b.rgbToHsb():null;},hsbToRgb:function(){var b=this.match(/\d{1,3}/g);return(b)?b.hsbToRgb():null;}});})();Locale.define("en-GB","Date",{dateOrder:["date","month","year"],shortDate:"%d/%m/%Y",shortTime:"%H:%M"}).inherit("en-US","Date");
